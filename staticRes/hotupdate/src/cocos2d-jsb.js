...
"./CCGame": 6,
"./CCScheduler": 10,
"./component-scheduler": 34,
"./event-manager": 68,
"./event/event-target": 70,
...
t("./event/event-target")), f = t("./renderer/render-flow"), d = cc.Object.Flags.Destroying, _ = Math.PI / 180, p = !!cc.ActionManager, v = function() {}, g = cc.v3(), m = cc.quat(), y = cc.v3(), E = cc.v3(), C = cc.quat(), T = cc.quat(), A = cc.v3(), x = cc.v3(), b = cc.v3(), S = cc.v3(), R = cc.v3(), w = cc.quat(), O = cc.quat(), L = cc.v3(), M = n.quat.create(), D = cc.v3(), I = cc.v3(), N = cc.quat(), P = cc.quat(), F = (cc.quat(), 
...
var i = this._contentSize.width, r = this._contentSize.height, s = D, o = I, a = cc.Camera.findCamera(this);
...
n.trs.toScale(R, r);
n.vec3.mul(e, e, R);
n.trs.toRotation(O, r);
n.vec3.transformQuat(e, e, O);
...
lookAt: function(t, e) {
this.getWorldPosition(L);
n.vec3.sub(L, L, t);
n.vec3.normalize(L, L);
n.quat.fromViewUp(M, L, e);
...
this._worldMatDirty = !0;
t === U.POSITION ? this._renderFlag |= f.FLAG_WORLD_TRANSFORM : this._renderFlag |= f.FLAG_TRANSFORM;
},
...
"./platform/js": 126,
"./renderer/render-flow": 155,
"./utils/affine-transform": 183,
"./utils/base-node": 184,
"./utils/prefab-helper": 193,
"./utils/trans-pool": 199,
"./vmath": 216
} ],
8: [ (function(t, e, i) {
"use strict";
...
var D = e._isAbsVerticalCenter ? e._verticalCenter : e._verticalCenter * w, I = (.5 - d.y) * f.height;
if (h) {
D *= u.y;
I += s.y;
I *= u.y;
...
v = I + (L - .5) * O + D;
} else v = e.isAlignBottom ? R + L * O : S + (L - 1) * O;
}
}
t.setPosition(p, v);
}
...
var O = u * (1 - S) * R;
if (e) {
var L = d + O + u * (u > 0 ? this.paddingRight : this.paddingLeft), M = this.horizontalDirection === c.LEFT_TO_RIGHT && L > (1 - o.x) * t, D = this.horizontalDirection === c.RIGHT_TO_LEFT && L < -o.x * t;
if (M || D) {
if (w >= p) {
0 === v && (v = p);
_ += v;
...
var I = i(A, _, g);
t >= R + this.paddingLeft + this.paddingRight && n && A.setPosition(cc.v2(d, I));
var N, P = 1, F = 0 === p ? w : p;
if (this.verticalDirection === a.TOP_TO_BOTTOM) {
m = m || this.node._contentSize.height;
(N = I + (P = -1) * (F * y + this.paddingBottom)) < m && (m = N);
} else {
m = m || -this.node._contentSize.height;
(N = I + P * (F * y + this.paddingTop)) > m && (m = N);
}
d += O;
}
}
...
var O = u * (1 - S) * w;
if (e) {
var L = d + O + u * (u > 0 ? this.paddingTop : this.paddingBottom), M = this.verticalDirection === a.BOTTOM_TO_TOP && L > (1 - o.y) * t, D = this.verticalDirection === a.TOP_TO_BOTTOM && L < -o.y * t;
if (M || D) {
if (R >= p) {
0 === v && (v = p);
_ += v;
...
var I = i(A, _, g);
t >= w + (this.paddingTop + this.paddingBottom) && n && A.setPosition(cc.v2(I, d));
var N, P = 1, F = 0 === p ? R : p;
if (this.horizontalDirection === c.RIGHT_TO_LEFT) {
P = -1;
m = m || this.node._contentSize.width;
(N = I + P * (F * y + this.paddingLeft)) < m && (m = N);
} else {
m = m || -this.node._contentSize.width;
(N = I + P * (F * y + this.paddingRight)) > m && (m = N);
}
d += O;
}
}
...
var s = t("../utils/misc"), o = t("../assets/material/CCMaterial"), a = t("./CCRenderComponent"), c = t("../renderer/render-flow"), l = t("../graphics/graphics"), u = t("../CCNode"), h = cc.v2(), f = r.mat4.create(), d = [];
function _(t, e, i) {
d.length = 0;
...
onRestore: function() {
this._createGraphics();
this._type !== p.IMAGE_STENCIL ? this._updateGraphics() : this._applySpriteFrame();
},
onEnable: function() {
this._super();
if (this._type === p.IMAGE_STENCIL) {
...
this.setVertsDirty();
this._assembler && this._assembler._renderData && this.markForUpdateRenderData(!0);
...
this._exitMaterial.effect.setStencilEnabled(n.default.STENCIL_DISABLE);
}
...
this._clearGraphics = new l();
cc.Assembler.init(this._clearGraphics);
this._clearGraphics.node = new u();
...
if (!r.mat4.invert(f, e._worldMatrix)) return !1;
r.vec2.transformMat4(o, t, f);
o.x += e._anchorPoint.x * n;
o.y += e._anchorPoint.y * s;
var a = !1;
if (this.type === p.RECT || this.type === p.IMAGE_STENCIL) a = o.x >= 0 && o.y >= 0 && o.x <= n && o.y <= s; else if (this.type === p.ELLIPSE) {
var c = n / 2, l = s / 2, u = o.x - .5 * n, d = o.y - .5 * s;
a = u * u / (c * c) + d * d / (l * l) < 1;
}
this.inverted && (a = !a);
return a;
...
"../../renderer/gfx": 237,
"../../renderer/memop/recycle-pool": 238,
"./aabb": 74,
"./ray": 77,
"./triangle": 78
} ],
...
if (cc.game.renderType !== cc.game.RENDER_TYPE_CANVAS) {
var t = this.sharedMaterials[0];
(t = t ? r.getInstantiatedMaterial(t, this) : r.getInstantiatedBuiltinMaterial("2d-base", this)).define("CC_USE_MODEL", !0);
this.setMaterial(0, t);
} else this.disableRender();
},
moveTo: function(t, e) {
...
var d, _, p, v = 0, g = 0, m = 0, y = 0, E = 0, C = 0, T = 0, A = 0, x = 0, b = 0, S = 0, R = 0, w = 0;
g = h - u;
if (f = f || !1) if (l(g) >= 2 * r) g = 2 * r; else for (;g < 0; ) g += 2 * r; else if (l(g) >= 2 * r) g = 2 * -r; else for (;g > 0; ) g -= 2 * r;
p = 0 | o(1, s(l(g) / (.5 * r) + .5, 5));
m = l(4 / 3 * (1 - a(d = g / p / 2)) / c(d));
f || (m = -m);
for (_ = 0; _ <= p; _++) {
y = a(v = u + g * (_ / p));
E = c(v);
...
A = -E * n * m;
x = y * n * m;
0 === _ ? t.moveTo(C, T) : t.bezierCurveTo(b + R, S + w, C - A, T - x, C, T);
b = C;
S = T;
R = A;
w = x;
...
tesselateBezier: function t(e, i, r, s, o, a, c, u, h, f, d) {
var _, p, v, g, m, y, E, C, T, A, x, b, S, R, w, O;
if (!(f > 10)) {
m = .5 * (a + u);
y = .5 * (c + h);
E = .5 * ((_ = .5 * (i + s)) + (v = .5 * (s + a)));
C = .5 * ((p = .5 * (r + o)) + (g = .5 * (o + c)));
if (((w = l((s - u) * (R = h - r) - (o - h) * (S = u - i))) + (O = l((a - u) * R - (c - h) * S))) * (w + O) < e._tessTol * (S * S + R * R)) e._addPoint(u, h, 0 === d ? d | n.PT_BEVEL : d); else {
t(e, i, r, _, p, E, C, x = .5 * (E + (T = .5 * (v + m))), b = .5 * (C + (A = .5 * (g + y))), f + 1, 0);
t(e, x, b, T, A, m, y, u, h, f + 1, d);
}
}
}
};
...
this.async = !0;
this.pipeline = null;
this.extMap = n.mixin(t, O);
};
L.ID = "Loader";
L.prototype.addHandlers = function(t) {
this.extMap = n.mixin(this.extMap, t);
};
L.prototype.handle = function(t, e) {
return (this.extMap[t.type] || this.extMap.default).call(this, t, e);
};
s.Loader = e.exports = L;
}), {
...
var b = A[x];
for (var p in b) {
var S = b[p], R = S[0], w = S[1], O = cc.js._getClassById(w);
if (O) {
_[p] = new v(x + "/" + R, O);
var L = cc.path.extname(R);
L && (R = R.slice(0, -L.length));
var M = 1 === S[2];
C[x] || (C[x] = new s());
C[x].add(R, p, O, !M);
...
"../load-pipeline/asset-table": 86,
"../load-pipeline/auto-release-utils": 88,
"../load-pipeline/md5-pipe": 95,
"../load-pipeline/pack-downloader": 96,
"../load-pipeline/subpackage-pipe": 99,
"../utils/decode-uuid": 186,
"./js": 126,
"./utils": 130
} ],
106: [ (function(t, e, i) {
...
O._isCCClass(d) && v(o.getClassAttrs(a), o.getClassAttrs(d));
}
h.constructor = a;
}
u || (h.__initProps__ = A);
...
var C = E(c), T = y(u, "requireComponent"), A = E(f), x = y(d, "executionOrder"), b = E(c), S = E(c), R = E(f), w = E(f), O = E(f);
...
"../utils/mutable-forward-iterator": 191,
"./id-generater": 122
} ],
127: [ (function(t, e, i) {
"use strict";
...
"./forward-renderer": 137,
"./render-component-handle": 139,
"./render-flow": 140,
"./renderers": 143
} ],
139: [ (function(t, e, i) {
...
141: [ (function(t, e, i) {
"use strict";
var n = t("../../../../graphics/helper"), r = t("../../../../graphics/types"), s = t("../../../../platform/js"), o = r.LineJoin, a = r.LineCap;
function c() {
this.cmds = [];
this.style = {
strokeStyle: "black",
...
var i = e.node, n = i._worldMatrix.m, r = n[0], s = n[1], o = n[4], a = n[5], c = n[12], l = n[13];
t.transform(r, s, o, a, c, l);
t.save();
t.globalAlpha = i.opacity / 255;
var u = e._impl.style;
t.strokeStyle = u.strokeStyle;
t.fillStyle = u.fillStyle;
t.lineWidth = u.lineWidth;
t.lineJoin = u.lineJoin;
t.miterLimit = u.miterLimit;
for (var h = !0, f = e._impl.cmds, d = 0, _ = f.length; d < _; d++) {
var p = f[d], v = p[0], g = p[1];
if ("moveTo" === v && h) {
t.beginPath();
h = !1;
} else "fill" !== v && "stroke" !== v && "fillRect" !== v || (h = !0);
...
i.default = a;
n.default.register(r.default, a);
e.exports = i.default;
}), {
"../../../../graphics/graphics": 79,
"../../../assembler": 134,
...
var a = t("../../../components/CCMask"), c = (t("./graphics"), (function(t) {
o(e, t);
function e() {
r(this, e);
...
e.prototype.draw = function(t, e) {
t.save();
e._graphics._assembler.draw(t, e._graphics);
t.clip();
};
...
"../../renderer/config": 231,
"../../renderer/core/input-assembler": 233,
"../../renderer/core/pass": 234,
"../../renderer/gfx": 237,
"../../renderer/renderers/forward-renderer": void 0,
"../../renderer/scene/scene": void 0,
"./canvas": 138,
"./canvas/Device": 135,
"./canvas/Texture2D": 136,
...
this.line = 0;
this.hash = "";
}, f = cc.rect(), d = null, _ = [], p = [], v = [], g = [], m = null, y = 0, E = 0, C = 0, T = 0, A = 0, x = 1, b = null, S = cc.size(), R = "", w = 0, O = 0, L = 0, M = 0, D = 0, I = 0, N = 0, P = !1, F = 0, B = 0, z = 0, k = (function(t) {
o(e, t);
function e() {
r(this, e);
return s(this, t.apply(this, arguments));
...
var p = R.charAt(d);
if ("\n" !== p) {
for (var g = t(R, d, e), C = c, b = l, w = o, O = n, L = !1, M = 0; M < g; ++M) {
var N = d + M;
if ("\r" !== (p = R.charAt(N))) if (h = u.fontAtlas.getLetterDefinitionForChar(p, u)) {
var k = O + h.offsetX * x - u.margin;
if (P && z > 0 && n > 0 && k + h.w * x > z && !a.isUnicodeSpace(p)) {
v.push(o);
o = 0;
i++;
n = 0;
...
N + 1 < _.length && N < e - 1 && (O += _[N + 1]);
O += h.xAdvance * x + D - 2 * u.margin;
...
if (!s) return r;
for (var o = s.xAdvance * x + D, c = e + 1; c < i; ++c) {
n = t.charAt(c);
...
var a = t("../../../utils/text-utils"), c = t("../../../platform/CCMacro"), l = t("../../../components/CCLabel"), u = t("../../../components/CCLabelOutline"), h = t("../../../components/CCLabelShadow"), f = l.Overflow, d = t("../utils").deleteFromDynamicAtlas, _ = t("../utils").getFontFamily, p = (1 / 255).toFixed(3), v = null, g = null, m = null, y = "", E = "", C = 0, T = 0, A = [], x = cc.Size.ZERO, b = 0, S = 0, R = 0, w = null, O = "", L = f.NONE, M = !1, D = null, I = cc.Color.WHITE, N = null, P = cc.Color.BLACK, F = cc.rect(), B = cc.Size.ZERO, z = cc.Size.ZERO, k = !1, U = !1, H = !1, G = 0, V = cc.Vec2.ZERO, j = 0, W = void 0, Y = (function(t) {
o(e, t);
function e() {
r(this, e);
return s(this, t.apply(this, arguments));
...
U = t._isItalic;
H = t._isUnderline;
M = L !== f.NONE && (L === f.RESIZE_HEIGHT || t.enableWrapText);
(D = (D = u && t.getComponent(u)) && D.enabled && D.width > 0 ? D : null) && I.set(D.color);
...
v.strokeStyle = "rgba(" + I.r + ", " + I.g + ", " + I.b + ", " + I.a / 255 + ")";
v.lineWidth = 2 * D.width;
};
...
function n(t, e, i) {
i = i || 2;
var n, s, a, c, l, u, f, d = e && e.length, _ = d ? e[0] * i : t.length, p = r(t, 0, _, i, !0), v = [];
if (!p) return v;
d && (p = h(t, e, p, i));
if (t.length > 80 * i) {
n = a = t[0];
...
var s, o;
if (r === M(t, e, i, n) > 0) for (s = e; s < i; s += n) o = w(s, t[s], t[s + 1], o); else for (s = i - n; s >= e; s -= n) o = w(s, t[s], t[s + 1], o);
if (o && T(o, o.next)) {
O(o);
o = o.next;
}
...
if (y(e.x, e.y, i.x, i.y, n.x, n.y, r.x, r.y) && C(r.prev, r, r.next) >= 0) return !1;
r = r.next;
}
return !0;
}
...
for (var a = r.x < s.x ? r.x < o.x ? r.x : o.x : s.x < o.x ? s.x : o.x, c = r.y < s.y ? r.y < o.y ? r.y : o.y : s.y < o.y ? s.y : o.y, l = r.x > s.x ? r.x > o.x ? r.x : o.x : s.x > o.x ? s.x : o.x, u = r.y > s.y ? r.y > o.y ? r.y : o.y : s.y > o.y ? s.y : o.y, h = g(a, c, e, i, n), f = g(l, u, e, i, n), d = t.nextZ; d && d.z <= f; ) {
if (d !== t.prev && d !== t.next && y(r.x, r.y, s.x, s.y, o.x, o.y, d.x, d.y) && C(d.prev, d, d.next) >= 0) return !1;
d = d.nextZ;
}
d = t.prevZ;
for (;d && d.z >= h; ) {
...
if (!T(r, s) && A(r, n, n.next, s) && b(r, s) && b(s, r)) {
e.push(r.i / i);
e.push(n.i / i);
e.push(s.i / i);
O(n);
...
n = i.next;
for (;n !== l; ) {
if (r >= n.x && n.x >= u && y(s < h ? r : o, s, u, h, s < h ? o : r, s, n.x, n.y) && ((c = Math.abs(s - n.y) / (r - n.x)) < f || c === f && n.x > i.x) && b(n, t)) {
i = n;
f = c;
}
n = n.next;
...
function E(t, e) {
return t.next.i !== e.i && t.prev.i !== e.i && !x(t, e) && b(t, e) && b(e, t) && S(t, e);
}
function C(t, e, i) {
...
function R(t, e) {
var i = new L(t.i, t.x, t.y), n = new L(e.i, e.x, e.y), r = t.next, s = e.prev;
t.next = e;
e.prev = t;
i.next = r;
r.prev = i;
...
var r = e && e.length, s = r ? e[0] * i : t.length, o = Math.abs(M(t, 0, s, i));
if (r) for (var a = 0, c = e.length; a < c; a++) {
var l = e[a] * i, u = a < c - 1 ? e[a + 1] * i : t.length;
o -= Math.abs(M(t, l, u, i));
}
var h = 0;
for (a = 0; a < n.length; a += 3) {
var f = n[a] * i, d = n[a + 1] * i, _ = n[a + 2] * i;
...
var l = t("../../mesh-buffer"), u = t("../../vertex-format").vfmtPosColor, h = t("../../../index"), f = t("../../../../graphics/graphics"), d = t("../../../../graphics/types").PointFlags, _ = f.LineJoin, p = f.LineCap, v = t("./earcut"), g = (t("./impl"), 
Math.PI), m = Math.min, y = Math.max, E = Math.ceil, C = Math.acos, T = Math.cos, A = Math.sin, x = Math.atan2;
function b(t, e, i) {
var n = 2 * C(t / (t + i));
return y(2, E(e / n));
}
...
var e = .5 * t.lineWidth, i = t.lineCap, n = t.lineJoin, r = t.miterLimit, s = t._impl, o = b(e, g, s._tessTol);
this._calculateJoins(s, e, n, r);
for (var a = s._paths, c = 0, l = s._pathOffset, u = s._pathLength; l < u; l++) {
var h = a[l], f = h.points.length;
n === _.ROUND ? c += 2 * (f + h.nbevel * (o + 2) + 1) : c += 2 * (f + 5 * h.nbevel + 1);
h.closed || (i === p.ROUND ? c += 2 * (2 * o + 2) : c += 12);
}
for (var v = this.genBuffer(t, c), m = v.meshbuffer, y = m._vData, E = m._iData, C = s._pathOffset, T = s._pathLength; C < T; C++) {
var A, x = a[C], S = x.points, R = S.length, w = v.vertexStart, O = void 0, L = void 0, M = void 0, D = void 0;
if (A = x.closed) {
O = S[R - 1];
L = S[0];
M = 0;
...
I.normalizeSelf();
var N = I.x, P = I.y;
i === p.BUTT ? this._buttCapStart(O, N, P, e, 0) : i === p.SQUARE ? this._buttCapStart(O, N, P, e, e) : i === p.ROUND && this._roundCapStart(O, N, P, e, o);
}
for (var F = M; F < D; ++F) {
if (n === _.ROUND) this._roundJoin(O, L, e, e, o); else if (0 != (L.flags & (d.PT_BEVEL | d.PT_INNERBEVEL))) this._bevelJoin(O, L, e, e); else {
this._vset(L.x + L.dmx * e, L.y + L.dmy * e);
this._vset(L.x - L.dmx * e, L.y - L.dmy * e);
}
O = L;
L = S[F + 1];
...
z.normalizeSelf();
var k = z.x, U = z.y;
i === p.BUTT ? this._buttCapEnd(L, k, U, e, 0) : i === p.SQUARE ? this._buttCapEnd(L, k, U, e, e) : i === p.ROUND && this._roundCapEnd(L, k, U, e, o);
}
for (var H = v.indiceStart, G = w + 2, V = v.vertexStart; G < V; G++) {
E[H++] = G - 2;
E[H++] = G - 1;
E[H++] = G;
}
...
if (0 !== _) {
for (var p = o.vertexStart, g = 0; g < _; ++g) this._vset(d[g].x, d[g].y);
var m = o.indiceStart;
if (f.complex) {
for (var y = [], E = p, C = o.vertexStart; E < C; E++) {
var T = 3 * E;
y.push(c[T]);
y.push(c[T + 1]);
}
...
for (var x = 0, b = A.length; x < b; x++) l[m++] = A[x] + p;
} else for (var S = p, R = p + 2, w = o.vertexStart; R < w; R++) {
l[m++] = S;
l[m++] = R - 1;
l[m++] = R;
}
...
c.nbevel = 0;
for (var p = 0; p < u; p++) {
var v, g, E = h.dy, C = -h.dx, T = f.dy, A = -f.dx;
f.dmx = .5 * (E + T);
f.dmy = .5 * (C + A);
if ((v = f.dmx * f.dmx + f.dmy * f.dmy) > 1e-6) {
var x = 1 / v;
x > 600 && (x = 600);
f.dmx *= x;
f.dmy *= x;
...
v * (g = y(11, m(h.len, f.len) * r)) * g < 1 && (f.flags |= d.PT_INNERBEVEL);
f.flags & d.PT_CORNER && (v * n * n < 1 || i === _.BEVEL || i === _.ROUND) && (f.flags |= d.PT_BEVEL);
0 != (f.flags & (d.PT_BEVEL | d.PT_INNERBEVEL)) && c.nbevel++;
h = f;
f = l[p + 1];
}
}
...
if (0 != (e.flags & d.PT_LEFT)) {
var h = this._chooseBevel(e.flags & d.PT_INNERBEVEL, t, e, i), f = h[0], _ = h[1], p = h[2], v = h[3], m = x(-o, -s), y = x(-c, -a);
y > m && (y -= 2 * g);
this._vset(f, _);
this._vset(l - s * n, e.y - o * n);
for (var C = S(E((m - y) / g) * r, 2, r), b = 0; b < C; b++) {
var R = m + b / (C - 1) * (y - m), w = l + T(R) * n, O = u + A(R) * n;
this._vset(l, u);
this._vset(w, O);
}
this._vset(p, v);
...
var L = this._chooseBevel(e.flags & d.PT_INNERBEVEL, t, e, -n), M = L[0], D = L[1], I = L[2], N = L[3], P = x(o, s), F = x(c, a);
F < P && (F += 2 * g);
this._vset(l + s * n, u + o * n);
this._vset(M, D);
for (var B = S(E((F - P) / g) * r, 2, r), z = 0; z < B; z++) {
var k = P + z / (B - 1) * (F - P), U = l + T(k) * i, H = u + A(k) * i;
this._vset(U, H);
this._vset(l, u);
}
this._vset(l + a * n, u + c * n);
...
var r = void 0, s = void 0, o = void 0, a = void 0, c = void 0, l = void 0, u = void 0, h = void 0, f = t.dy, _ = -t.dx, p = e.dy, v = -e.dx;
if (e.flags & d.PT_LEFT) {
var g = this._chooseBevel(e.flags & d.PT_INNERBEVEL, t, e, i);
c = g[0];
l = g[1];
u = g[2];
h = g[3];
...
this._vset(u, h);
this._vset(e.x - p * n, e.y - v * n);
} else {
var m = this._chooseBevel(e.flags & d.PT_INNERBEVEL, t, e, -n);
r = m[0];
s = m[1];
o = m[2];
a = m[3];
...
i.default = R;
n.default.register(cc.Graphics, R);
e.exports = i.default;
}), {
"../../../../../renderer/core/input-assembler": 233,
"../../../../graphics/graphics": 79,
...
var a = t("../../../components/CCMask"), c = t("../../render-flow"), l = t("./sprite/2d/simple"), u = t("./graphics"), h = t("../../../../renderer/gfx"), f = t("../vertex-format").vfmtPos, d = 8, _ = [];
function p() {
return 1 << _.length - 1;
}
function v() {
...
g(t._clearMaterial, i, o, n, r, s);
var a = e.getBuffer("mesh", f), c = a.request(4, 6), l = c.indiceOffset, u = c.byteOffset >> 2, d = c.vertexOffset, _ = a._vData, v = a._iData;
_[u++] = -1;
_[u++] = -1;
_[u++] = -1;
_[u++] = 1;
...
g(t.sharedMaterials[0], i, o, n, r, s);
e.material = t.sharedMaterials[0];
...
function T(t) {
var e = h.DS_FUNC_EQUAL, i = h.STENCIL_OP_KEEP, n = v(), r = n, s = p(), o = _[_.length - 1];
g(o._enableMaterial, e, i, n, r, s);
t._flushMaterial(o._enableMaterial);
}
var A = i.MaskAssembler = (function(t) {
o(e, t);
function e() {
r(this, e);
return s(this, t.apply(this, arguments));
...
(t._type !== a.Type.IMAGE_STENCIL || t.spriteFrame) && y(t, e);
t.node._renderFlag |= c.FLAG_UPDATE_RENDER_DATA;
};
return e;
})(l);
n.default.register(a, A);
}), {
"../../../../renderer/gfx": 237,
"../../../components/CCMask": 43,
"../../assembler": 134,
...
if (o.length > 1) {
var c = o[0].point.x - r, d = o[0].point.y - s;
c * c + d * d < t.minSeg && (a = o[0]);
}
if (!a) {
a = new l();
o.splice(0, 0, a);
...
var _, p = 0;
if (!(o.length < 2)) {
var v = t._color, g = v.r, m = v.g, y = v.b, E = v.a, C = o[1];
C.distance = a.point.sub(C.point, h).mag();
h.normalizeSelf();
C.setDir(h.x, h.y);
a.setDir(h.x, h.y);
var T = this._renderData._flexBuffer;
T.reserve(2 * o.length, 6 * (o.length - 1));
for (var A = T.vData, x = T.uintVData, b = t._fadeTime, S = !1, R = o.length - 1; R >= 0; R--) {
var w = o[R], O = w.point, L = w.dir;
w.time -= e;
if (w.time < 0) o.splice(R, 1); else {
var M = w.time / b, D = o[R - 1];
if (!S) {
if (!D) {
o.splice(R, 1);
continue;
...
S = !0;
f(u, L);
var I = (M * E << 24 >>> 0) + (y << 16) + (m << 8) + g, N = 5 * p;
A[N] = O.x + u.x * i;
A[N + 1] = O.y + u.y * i;
A[N + 2] = 1;
A[N + 3] = M;
...
for (var f = a._iData, d = l.indiceOffset, _ = l.vertexOffset, p = 0, v = r; p < v; p += 2) {
var g = _ + p;
f[d++] = g;
f[d++] = g + 2;
f[d++] = g + 1;
...
"./CCPath": 182,
"./find": 187,
"./mutable-forward-iterator": 191,
"./profiler/CCProfiler": 194
} ],
190: [ (function(t, e, i) {
"use strict";
...
var i = e.m, n = t.m, r = i[0], s = i[1], o = i[2], a = i[3], c = i[4], l = i[5], u = i[6], h = i[7], f = i[8], d = i[9], _ = i[10], p = i[11], v = i[12], g = i[13], m = i[14], y = i[15], E = r * l - s * c, C = r * u - o * c, T = r * h - a * c, A = s * u - o * l, x = s * h - a * l, b = o * h - a * u, S = f * g - d * v, R = f * m - _ * v, w = f * y - p * v, O = d * m - _ * g, L = d * y - p * g, M = _ * y - p * m, D = E * M - C * L + T * O + A * w - x * R + b * S;
if (!D) return null;
D = 1 / D;
n[0] = (l * M - u * L + h * O) * D;
n[1] = (u * w - c * M - h * R) * D;
...
var s, o, a, c, l, u, h, f, d, _, p, v, g, m, y, E, C, T, A, x, b, S, R, w, O = e.m, L = t.m, M = r.x, D = r.y, I = r.z, N = Math.sqrt(M * M + D * D + I * I);
...
t.equals = function(t, e) {
var i = t.m, r = e.m, s = i[0], o = i[1], a = i[2], c = i[3], l = i[4], u = i[5], h = i[6], f = i[7], d = i[8], _ = i[9], p = i[10], v = i[11], g = i[12], m = i[13], y = i[14], E = i[15], C = r[0], T = r[1], A = r[2], x = r[3], b = r[4], S = r[5], R = r[6], w = r[7], O = r[8], L = r[9], M = r[10], D = r[11], I = r[12], N = r[13], P = r[14], F = r[15];
return Math.abs(s - C) <= n.EPSILON * Math.max(1, Math.abs(s), Math.abs(C)) && Math.abs(o - T) <= n.EPSILON * Math.max(1, Math.abs(o), Math.abs(T)) && Math.abs(a - A) <= n.EPSILON * Math.max(1, Math.abs(a), Math.abs(A)) && Math.abs(c - x) <= n.EPSILON * Math.max(1, Math.abs(c), Math.abs(x)) && Math.abs(l - b) <= n.EPSILON * Math.max(1, Math.abs(l), Math.abs(b)) && Math.abs(u - S) <= n.EPSILON * Math.max(1, Math.abs(u), Math.abs(S)) && Math.abs(h - R) <= n.EPSILON * Math.max(1, Math.abs(h), Math.abs(R)) && Math.abs(f - w) <= n.EPSILON * Math.max(1, Math.abs(f), Math.abs(w)) && Math.abs(d - O) <= n.EPSILON * Math.max(1, Math.abs(d), Math.abs(O)) && Math.abs(_ - L) <= n.EPSILON * Math.max(1, Math.abs(_), Math.abs(L)) && Math.abs(p - M) <= n.EPSILON * Math.max(1, Math.abs(p), Math.abs(M)) && Math.abs(v - D) <= n.EPSILON * Math.max(1, Math.abs(v), Math.abs(D)) && Math.abs(g - I) <= n.EPSILON * Math.max(1, Math.abs(g), Math.abs(I)) && Math.abs(m - N) <= n.EPSILON * Math.max(1, Math.abs(m), Math.abs(N)) && Math.abs(y - P) <= n.EPSILON * Math.max(1, Math.abs(y), Math.abs(P)) && Math.abs(E - F) <= n.EPSILON * Math.max(1, Math.abs(E), Math.abs(F));
};
return t;
})();
i.default = s;
...
230: [ (function(t, e, i) {
"use strict";
var n, r, s, o = 512, a = 513, c = 514, l = 515, u = 516, h = 517, f = 518, d = 519, _ = 32774, p = 32778, v = 32779, g = 0, m = 1, y = 768, E = 769, C = 774, T = 775, A = 770, x = 771, b = 772, S = 773, R = 32769, w = 32770, O = 32771, L = 32772, M = 776, D = 7680, I = 7681, N = 7682, P = 34055, F = 7683, B = 34056, z = 5386, k = 0, U = 1028, H = 1029;
(function(t) {
...
var G, V, j, W, Y, X, q, Z, K, J, $, Q, tt, et, it, nt, rt, st, ot, at, ct, lt, ut, ht, ft, dt, _t, pt, vt, gt, mt, yt, Et, Ct, Tt;
(function() {
function t(t) {
...
xt), Ot = ((bt = {})[V.BOOL] = j.R32I, bt[V.INT] = j.R32I, bt[V.INT2] = j.RG32I, 
bt[V.INT3] = j.RGB32I, bt[V.INT4] = j.RGBA32I, bt[V.FLOAT] = j.R32F, bt[V.FLOAT2] = j.RG32F, 
bt[V.FLOAT3] = j.RGB32F, bt[V.FLOAT4] = j.RGBA32F, bt), Lt = {
BACK: H,
FRONT: U,
NONE: k,
ADD: _,
...
if (t) if (t.loaded) {
var e = this.sharedMaterials[0];
(e = e ? r.getInstantiatedMaterial(e, this) : r.getInstantiatedBuiltinMaterial("2d-sprite", this)).define("CC_USE_MODEL", !0);
...
this.disableRender();
t.once("load", this._activateMaterial, this);
} else this.disableRender();
},
...
this._cacheMode === u.SHARED_CACHE ? this._armatureCache = a.sharedCache : this._cacheMode === u.PRIVATE_CACHE && (this._armatureCache = new a());
...
"../../cocos2d/core/CCNode": 7,
"../../cocos2d/core/assets/material/CCMaterial": 29,
"../../cocos2d/core/components/CCRenderComponent": 48,
"../../cocos2d/core/event/event-target": 70,
"../../cocos2d/core/graphics/graphics": 79,
...
"./DragonBonesAsset": 245,
"./DragonBonesAtlasAsset": 246,
...
var a = t("./ArmatureDisplay"), c = t("../../cocos2d/core/renderer/render-flow"), l = cc.gfx, u = cc.vmath.mat4, h = cc.color(255, 0, 0, 255), f = cc.color(0, 0, 255, 255), d = void 0, _ = void 0, p = void 0, v = void 0, g = void 0, m = void 0, y = void 0, E = void 0, C = void 0, T = void 0, A = void 0, x = void 0, b = void 0, S = void 0, R = void 0, w = void 0, O = void 0, L = void 0, M = void 0, D = void 0, I = void 0, N = void 0, P = void 0, F = void 0, B = void 0, z = void 0, k = void 0, U = void 0, H = void 0, G = void 0;
function V(t, e) {
if (!t) return null;
var i = void 0, n = void 0;
switch (e) {
case 1:
i = g ? cc.macro.ONE : cc.macro.SRC_ALPHA;
n = cc.macro.ONE;
break;
...
var r = !A.enableBatch, s = t.getId() + i + n + r, o = A.sharedMaterials[0];
if (!o) return null;
var a = A._materialCache, c = a[s];
if (c) {
if (c.texture !== t) {
...
a[o._hash] ? (c = new cc.Material()).copy(o) : c = o;
c.define("CC_USE_MODEL", r);
c.setProperty("texture", t);
c.effect.setBlend(!0, l.BLEND_FUNC_ADD, i, n, l.BLEND_FUNC_ADD, i, n);
a[s] = c;
c.updateHash(s);
}
return c;
...
e.prototype.updateRenderData = function(t, e) {};
e.prototype.realTimeTraverse = function(t, e, i) {
for (var n = t._slots, r = void 0, s = void 0, o = void 0, a = void 0, c = void 0, l = void 0, h = void 0, f = void 0, d = void 0, _ = void 0, p = 0, v = n.length; p < v; p++) {
h = (f = n[p])._color;
if (f._visible && f._displayData) {
e ? f._mulMat(f._worldMatrix, e, f._matrix) : u.copy(f._worldMatrix, f._matrix);
if (f.childArmature) this.realTimeTraverse(f.childArmature, f._worldMatrix, i * h.a / 255); else if (a = V(f.getTexture(), f._blendMode)) {
if (y || a._hash !== T.material._hash) {
y = !1;
T._flush();
T.node = C;
T.material = a;
...
for (var A = 0, D = l.length; A < D; A++) s[b++] = S + l[A];
}
}
}
};
...
var i = t.segments;
if (0 != i.length) {
var n = void 0, r = void 0, s = void 0, o = void 0, a = void 0, c = t.vertices, l = t.indices, u = 0, h = 0, f = 0;
if (e) {
var d = e.m;
B = d[0];
U = d[1];
...
var _ = 16 & F, p = _ && (1 === B && 0 === U && 0 === z && 1 === H), v = 0, g = t.colors, m = g[v++], A = m.vfOffset;
j(m, 1);
for (var D = 0, I = i.length; D < I; D++) {
var N = i[D];
o = V(N.tex, N.blendMode);
if (y || o._hash !== T.material._hash) {
y = !1;
T._flush();
T.node = C;
T.material = o;
...
r = E._iData;
s = E._uintVData;
for (var P = b, W = b + w; P < W; P++) r[P] = S + l[h++];
f = N.vfCount;
n.set(c.subarray(u, u + f), x);
u += f;
if (p) for (var Y = x, X = x + f; Y < X; Y += 5) {
n[Y] += k;
n[Y + 1] += G;
} else if (_) for (var q = x, Z = x + f; q < Z; q += 5) {
O = n[q];
L = n[q + 1];
n[q] = O * B + L * z + k;
n[q + 1] = O * U + L * H + G;
}
if (1 & F) for (var K = u - f, J = x + 4, $ = x + 4 + f; J < $; J += 5, K += 5) {
if (K >= A) {
j(m = g[v++], 1);
A = m.vfOffset;
}
...
s.strokeColor = h;
s.fillColor = f;
for (var o = i.getBones(), a = 0, l = o.length; a < l; a++) {
var u = o[a], m = Math.max(u.boneData.length, 5), x = u.globalTransformMatrix.tx, b = -u.globalTransformMatrix.ty, S = x + u.globalTransformMatrix.a * m, R = b - u.globalTransformMatrix.b * m;
s.moveTo(x, b);
s.lineTo(S, R);
s.stroke();
}
...
i.default = W;
n.default.register(a, W);
e.exports = i.default;
}), {
"../../cocos2d/core/renderer/assembler": 134,
"../../cocos2d/core/renderer/render-flow": 155,
"./ArmatureDisplay": 244
} ],
249: [ (function(t, e, i) {
"use strict";
...
this._cacheMode === h.SHARED_CACHE ? this._skeletonCache = c.sharedCache : this._cacheMode === h.PRIVATE_CACHE && (this._skeletonCache = new c());
if (this.isAnimationCached()) {
...
if (t) {
var e = this.sharedMaterials[0];
(e = e ? o.getInstantiatedMaterial(e, this) : o.getInstantiatedBuiltinMaterial("2d-spine", this)).define("CC_USE_MODEL", !0);
this._prepareToRender(e);
} else this.disableRender();
...
var a = t("./Skeleton"), c = t("./lib/spine"), l = t("../../cocos2d/core/renderer/render-flow"), u = t("../../cocos2d/core/renderer/webgl/vertex-format"), h = u.vfmtPosUvColor, f = u.vfmtPosUvTwoColor, d = cc.gfx, _ = 0, p = [ 0, 1, 2, 2, 3, 0 ], v = cc.color(0, 0, 255, 255), g = cc.color(255, 0, 0, 255), m = cc.color(0, 255, 0, 255), y = cc.color(255, 255, 0, 255), E = null, C = null, T = null, A = null;
0;
var x = void 0, b = void 0, S = void 0, R = void 0, w = void 0, O = void 0, L = void 0, M = void 0, D = void 0, I = void 0, N = void 0, P = void 0, F = void 0, B = void 0, z = void 0, k = void 0, U = void 0, H = 0, G = 0, V = 0, j = 0, W = 0, Y = 0, X = 0, q = void 0, Z = void 0, K = void 0, J = void 0, $ = void 0, Q = void 0, tt = void 0, et = void 0, it = void 0, nt = void 0, rt = void 0, st = void 0, ot = void 0, at = void 0, ct = void 0, lt = void 0, ut = void 0, ht = void 0, ft = void 0, dt = void 0, _t = void 0, pt = void 0, vt = void 0, gt = void 0, mt = void 0, yt = void 0, Et = void 0, Ct = void 0, Tt = void 0;
function At(t, e) {
var i = void 0, n = void 0;
switch (e) {
case c.BlendMode.Additive:
i = x ? cc.macro.ONE : cc.macro.SRC_ALPHA;
n = cc.macro.ONE;
break;
...
var r = !gt.enableBatch, s = t.getId() + i + n + w + r, o = gt.sharedMaterials[0];
if (!o) return null;
var a = gt._materialCache, l = a[s];
if (l) {
if (l.getProperty("texture") !== t) {
l.setProperty("texture", t);
l.updateHash(s);
}
} else {
a[o._hash] ? (l = new cc.Material()).copy(o) : l = o;
l.define("CC_USE_MODEL", r);
l.define("USE_TINT", w);
l.setProperty("texture", t);
l.effect.setBlend(!0, d.BLEND_FUNC_ADD, i, n, d.BLEND_FUNC_ADD, i, n);
l.updateHash(s);
a[s] = l;
}
return l;
...
ht = t.fg * ct;
ft = t.fb * lt;
F = (dt << 24 >>> 0) + (ft << 16) + (ht << 8) + ut;
_t = t.dr * at;
pt = t.dg * ct;
vt = t.db * lt;
B = ((x ? 255 : 0) << 24 >>> 0) + (vt << 16) + (pt << 8) + _t;
}
function bt(t) {
...
var s = mt._vData, o = mt._iData, a = mt._uintVData, c = void 0;
E.a = i.a * e.a * t.a * P * 255;
b = x ? E.a : 255;
q = D * e.r * t.r * b;
Z = I * e.g * t.g * b;
K = N * e.b * t.b * b;
...
E.g = Z * i.g;
E.b = K * i.b;
if (null == r.darkColor) C.set(0, 0, 0, 1); else {
C.r = r.darkColor.r * q;
C.g = r.darkColor.g * Z;
C.b = r.darkColor.b * K;
}
C.a = x ? 255 : 0;
if (n.isClipping()) {
var l = s.subarray(V + 2);
n.clipTriangles(s.subarray(V), H, o.subarray(Y), W, l, E, C, w, k);
var u = new Float32Array(n.clippedVertices), h = n.clippedTriangles;
W = h.length;
H = u.length / U * k;
c = mt.request(H / k, W);
Y = c.indiceOffset, j = c.vertexOffset, V = c.byteOffset >> 2;
s = mt._vData, o = mt._iData;
a = mt._uintVData;
o.set(h, Y);
if (Tt) for (var f = 0, d = u.length, _ = V; f < d; f += U, _ += k) {
T.x = u[f];
T.y = u[f + 1];
E.set(u[f + 2], u[f + 3], u[f + 4], u[f + 5]);
A.x = u[f + 6];
A.y = u[f + 7];
w ? C.set(u[f + 8], u[f + 9], u[f + 10], u[f + 11]) : C.set(0, 0, 0, 0);
Tt.transform(T, A, E, C);
s[_] = T.x;
s[_ + 1] = T.y;
s[_ + 2] = A.x;
s[_ + 3] = A.y;
a[_ + 4] = bt(E);
w && (a[_ + 5] = bt(C));
} else for (var p = 0, v = u.length, g = V; p < v; p += U, g += k) {
s[g] = u[p];
s[g + 1] = u[p + 1];
s[g + 2] = u[p + 6];
s[g + 3] = u[p + 7];
F = (u[p + 5] << 24 >>> 0) + (u[p + 4] << 16) + (u[p + 3] << 8) + u[p + 2];
a[g + 4] = F;
if (w) {
B = (u[p + 11] << 24 >>> 0) + (u[p + 10] << 16) + (u[p + 9] << 8) + u[p + 8];
a[g + 5] = B;
}
}
} else if (Tt) for (var m = V, y = V + H; m < y; m += k) {
T.x = s[m];
T.y = s[m + 1];
A.x = s[m + 2];
A.y = s[m + 3];
...
var e = void 0, i = void 0, n = gt._skeleton, r = n.color, s = gt._debugRenderer, o = gt._clipper, a = null, l = void 0, u = void 0, h = void 0, f = void 0, d = void 0, _ = void 0, E = void 0, C = void 0, T = void 0, A = void 0;
S = gt._startSlotIndex;
R = gt._endSlotIndex;
J = !1;
-1 == S && (J = !0);
O = gt.debugSlots;
...
W = 0;
Y = 0;
for (var x = 0, b = n.drawOrder.length; x < b; x++) {
T = n.drawOrder[x];
S >= 0 && S == T.data.index && (J = !0);
if (J) {
R >= 0 && R == T.data.index && (J = !1);
H = 0;
W = 0;
if (l = T.getAttachment()) {
_ = l instanceof c.RegionAttachment;
E = l instanceof c.MeshAttachment;
if (l instanceof c.ClippingAttachment) o.clipStart(T, l); else if (_ || E) if (a = At(l.region.texture._texture, T.data.blendMode)) {
if ($ || a._hash !== yt.material._hash) {
$ = !1;
yt._flush();
yt.node = Et;
yt.material = a;
...
C = mt.request(4, 6);
Y = C.indiceOffset, j = C.vertexOffset, V = C.byteOffset >> 2;
e = mt._vData, i = mt._iData;
l.computeWorldVertices(T.bone, e, V, k);
if (s && O) {
s.strokeColor = v;
s.moveTo(e[V], e[V + 1]);
for (var D = V + k, I = V + H; D < I; D += k) s.lineTo(e[D], e[D + 1]);
s.close();
s.stroke();
}
} else if (E) {
d = l.triangles;
H = (l.worldVerticesLength >> 1) * k;
W = d.length;
C = mt.request(H / k, W);
Y = C.indiceOffset, j = C.vertexOffset, V = C.byteOffset >> 2;
e = mt._vData, i = mt._iData;
l.computeWorldVertices(T, 0, l.worldVerticesLength, e, V, k);
if (s && M) {
s.strokeColor = y;
for (var N = 0, P = d.length; N < P; N += 3) {
var F = d[N] * k + V, B = d[N + 1] * k + V, z = d[N + 2] * k + V;
s.moveTo(e[F], e[F + 1]);
s.lineTo(e[B], e[B + 1]);
s.lineTo(e[z], e[z + 1]);
s.close();
...
i.set(d, Y);
f = l.uvs;
for (var G = V, X = V + H, q = 0; G < X; G += k, q += 2) {
e[G + 2] = f[q];
e[G + 3] = f[q + 1];
}
u = l.color, h = T.color;
this.fillVertices(r, u, h, o, T);
if (W > 0) {
for (var Z = Y, K = Y + W; Z < K; Z++) i[Z] += j;
if (t) {
A = t.m;
et = A[0];
it = A[4];
...
st = A[5];
ot = A[13];
for (var at = V, ct = V + H; at < ct; at += k) {
Q = e[at];
tt = e[at + 1];
e[at] = Q * et + tt * it + nt;
e[at + 1] = Q * rt + tt * st + ot;
}
}
mt.adjust(H / k, W);
}
o.clipEndWithSlot(T);
} else o.clipEndWithSlot(T);
} else o.clipEndWithSlot(T); else o.clipEndWithSlot(T);
} else o.clipEndWithSlot(T);
} else o.clipEndWithSlot(T);
}
o.clipEnd();
...
s.strokeColor = g;
s.fillColor = v;
for (var ut = 0, ht = n.bones.length; ut < ht; ut++) {
var ft = (lt = n.bones[ut]).data.length * lt.a + lt.worldX, dt = lt.data.length * lt.c + lt.worldY;
s.moveTo(lt.worldX, lt.worldY);
s.lineTo(ft, dt);
s.stroke();
s.circle(lt.worldX, lt.worldY, 1.5 * Math.PI);
s.fill();
0 === ut && (s.fillColor = m);
}
}
...
var i = e.segments;
if (0 != i.length) {
var n = void 0, r = void 0, s = void 0, o = void 0, a = void 0, c = e.vertices, l = e.indices, u = void 0, h = 0, f = 0, d = 0;
if (t) {
u = t.m;
et = u[0];
rt = u[1];
...
var p = 16 & _, v = p && (1 === et && 0 === rt && 0 === it && 1 === st), g = 0, m = e.colors, y = m[g++], E = y.vfOffset;
xt(y);
for (var C = 0, T = i.length; C < T; C++) {
var A = i[C];
if (o = At(A.tex, A.blendMode)) {
if ($ || o._hash !== yt.material._hash) {
$ = !1;
yt._flush();
yt.node = Et;
yt.material = o;
...
r = mt._iData;
s = mt._uintVData;
for (var x = Y, b = Y + W; x < b; x++) r[x] = j + l[f++];
d = A.vfCount;
n.set(c.subarray(h, h + d), X);
h += d;
if (v) for (var S = X, R = X + d; S < R; S += 6) {
n[S] += nt;
n[S + 1] += ot;
} else if (p) for (var w = X, O = X + d; w < O; w += 6) {
Q = n[w];
tt = n[w + 1];
n[w] = Q * et + tt * it + nt;
n[w + 1] = Q * rt + tt * st + ot;
...
mt.adjust(G, W);
if (Ct) for (var L = h - d, M = X + 4, D = X + 4 + d; M < D; M += 6, L += 6) {
if (L >= E) {
xt(y = m[g++]);
E = y.vfOffset;
}
...
e.prototype.fillBuffers = function(t, e) {
var i = t.node;
i._renderFlag |= l.FLAG_UPDATE_RENDER_DATA;
if (t._skeleton) {
var n = i._color;
D = n.r / 255;
I = n.g / 255;
N = n.b / 255;
P = n.a / 255;
w = t.useTint || t.isAnimationCached();
z = w ? f : h;
k = w ? 6 : 5;
Et = t.node;
mt = e.getBuffer("spine", z);
yt = e;
gt = t;
$ = !0;
x = t.premultipliedAlpha;
b = 1;
_ = 0;
Ct = !1;
Tt = t._effectDelegate && t._effectDelegate._vertexEffect;
(4294967295 !== n._val || x) && (Ct = !0);
w && (_ |= 1);
var r = void 0;
if (gt.enableBatch) {
r = Et._worldMatrix;
...
i.default = St;
n.default.register(a, St);
e.exports = i.default;
}), {
"../../cocos2d/core/renderer/assembler": 134,
"../../cocos2d/core/renderer/render-flow": 155,
"../../cocos2d/core/renderer/webgl/vertex-format": 181,
"./Skeleton": 249,
"./lib/spine": void 0
} ],
254: [ (function(t, e, i) {
